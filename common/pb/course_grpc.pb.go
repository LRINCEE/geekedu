...
const (
	...
	CourseService_ListCourses_FullMethodName       = "/geekedu.CourseService/ListCourses"
	CourseService_GetCourse_FullMethodName         = "/geekedu.CourseService/GetCourse"
	CourseService_GetCoverUploadURL_FullMethodName = "/geekedu.CourseService/GetCoverUploadURL"
)
...
type CourseServiceClient interface {
	...
	GetCoverUploadURL(ctx context.Context, in *GetCoverUploadURLRequest, opts ...grpc.CallOption) (*GetCoverUploadURLResponse, error)
}
...
func (c *courseServiceClient) GetCoverUploadURL(ctx context.Context, in *GetCoverUploadURLRequest, opts ...grpc.CallOption) (*GetCoverUploadURLResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCoverUploadURLResponse)
	err := c.cc.Invoke(ctx, CourseService_GetCoverUploadURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CourseServiceServer interface {
	...
	GetCoverUploadURL(context.Context, *GetCoverUploadURLRequest) (*GetCoverUploadURLResponse, error)
...
func (UnimplementedCourseServiceServer) GetCoverUploadURL(context.Context, *GetCoverUploadURLRequest) (*GetCoverUploadURLResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCoverUploadURL not implemented")
}
...
func _CourseService_GetCoverUploadURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCoverUploadURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseServiceServer).GetCoverUploadURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseService_GetCoverUploadURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseServiceServer).GetCoverUploadURL(ctx, req.(*GetCoverUploadURLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CourseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCoverUploadURL",
			Handler:    _CourseService_GetCoverUploadURL_Handler,
		},
	},
